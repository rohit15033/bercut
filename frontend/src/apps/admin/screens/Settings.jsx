      ...
      <div style={{ marginTop: 28 }}>
        ...
        <div style={{ padding: 16, borderRadius: 10, border: `1px solid ${T.border}`, background: T.bg, marginBottom: 16 }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: T.muted, marginBottom: 5 }}>Placeholders: {'{{branch}}'} {'{{date}}'} {'{{total_penjualan}}'} {'{{total_pax}}'} {'{{cash}}'} {'{{card}}'} {'{{qr}}'} {'{{tip}}'} {'{{items_sold}}'} {'{{beverages_sold}}'} {'{{beverages_stock}}'} {'{{styling_sold}}'} {'{{styling_stock}}'} {'{{notes}}'}</div>
