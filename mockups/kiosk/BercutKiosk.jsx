...
import { BEVERAGES, C, FONT, PRODUCTS, SERVICES, fmt } from "./data.js";
...
function UpsellModal({ cart, extras, setExtras, onConfirm, onClose }) {
  const [initUpsell] = useState(() => getUpsell(cart));
