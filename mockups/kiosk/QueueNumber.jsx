      ...
      <div className="si" style={{ maxWidth:"clamp(360px,58vw,600px)", width:"100%", textAlign:"center" }}>
            ...
            {barber?.status==="available" ? (
              <>
                <div style={{ fontFamily:"'Inter',sans-serif", fontSize:"clamp(16px,2vw,20px)", fontWeight:800, color:"#1a5c1a" }}>
                  Langsung ke Kursi {barber?.chair}! · Proceed to Chair {barber?.chair}
                </div>
                <div style={{ fontSize:"clamp(11px,1.3vw,13px)", color:"#2e7d32" }}>
                  <strong>{barber?.name}</strong> siap sekarang · ready now
                </div>
              </>
            ) : (
              <>
        ...
        <div style={{ display:"flex", gap:12, marginBottom:16 }}>
          ...
          >
            ...
            <div style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"clamp(10px,1.2vw,12px)", fontWeight:400, color:C.muted }}>
              Add Another Person
            </div>
          </button>
