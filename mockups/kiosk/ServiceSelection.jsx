...
import { C, SERVICES, CATEGORIES, fmt } from "./data.js";
    ...
    <>
      ...
      <div style={{ height:"calc(100vh - clamp(51px,6.5vh,63px))", display:"flex", flexDirection:"column" }}>
        <div className="layout-split" style={{ flex:1, overflow:"hidden" }}>
          ...
          {/* Right: cart sidebar */}
          <div className="sidebar scroll-y" style={{ width:"clamp(240px,28vw,300px)", borderLeft:`1px solid ${C.border}`, background:C.bg, display:"flex", flexDirection:"column", padding:"clamp(14px,2vw,22px)" }}>
